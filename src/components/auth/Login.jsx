...
// components/auth/Login.jsx - Performance Optimized
...
// Memoized left panel to prevent unnecessary re-renders
...
const Login = () => {
  ...
  }, [activeTab, credentials, login, loginWithABHA, navigate, validateForm]);
